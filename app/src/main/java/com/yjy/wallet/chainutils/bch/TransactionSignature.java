...
public class TransactionSignature extends ECKey.ECDSASignature {
    ...
    public static boolean isEncodingCanonical(byte[] signature) {
        ...
        int hashType = (signature[signature.length-1] & 0xff) & ~(Transaction.SigHash.ANYONECANPAY.value| 0x40); // mask the byte to prevent sign-extension hurting us
    ...
    {
        int forkId = (signature[signature.length-1] & 0xff) & 0x40; // mask the byte to prevent sign-extension hurting us
