...
public class StrKey {
    ...
    public enum VersionByte {
        ...
        public static Optional<StrKey.VersionByte> findByValue(byte value) {
            for (StrKey.VersionByte versionByte : values()) {
    ...
    public static String encodeStellarAccountId(byte[] data) {
        char[] encoded = encodeCheck(StrKey.VersionByte.ACCOUNT_ID, data);
        return String.valueOf(encoded);
    }

    public static String encodeStellarAccountId(AccountID accountID) {
        char[] encoded = encodeCheck(StrKey.VersionByte.ACCOUNT_ID, accountID.getAccountID().getEd25519().getUint256());
        return String.valueOf(encoded);
    }
    ...
    public static StrKey.VersionByte decodeVersionByte(String data) {
        byte[] decoded = StrKey.base32Encoding.decode(java.nio.CharBuffer.wrap(data.toCharArray()));
        byte decodedVersionByte = decoded[0];
        Optional<StrKey.VersionByte> versionByteOptional = StrKey.VersionByte.findByValue(decodedVersionByte);
    ...
    public static byte[] decodeStellarAccountId(String data) {
        return decodeCheck(StrKey.VersionByte.ACCOUNT_ID, data.toCharArray());
    }

    public static char[] encodeStellarSecretSeed(byte[] data) {
        return encodeCheck(StrKey.VersionByte.SEED, data);
    }

    public static byte[] decodeStellarSecretSeed(char[] data) {
        return decodeCheck(StrKey.VersionByte.SEED, data);
    }

    public static String encodePreAuthTx(byte[] data) {
        char[] encoded = encodeCheck(StrKey.VersionByte.PRE_AUTH_TX, data);
        return String.valueOf(encoded);
    }

    public static byte[] decodePreAuthTx(String data) {
        return decodeCheck(StrKey.VersionByte.PRE_AUTH_TX, data.toCharArray());
    }
    ...
    public static byte[] decodeSha256Hash(String data) {
        return decodeCheck(StrKey.VersionByte.SHA256_HASH, data.toCharArray());
    }

    protected static char[] encodeCheck(StrKey.VersionByte versionByte, byte[] data) {
        try {
            ...
            if (StrKey.VersionByte.SEED != versionByte) {
    ...
    protected static byte[] decodeCheck(StrKey.VersionByte versionByte, char[] encoded) {
        ...
        if (StrKey.VersionByte.SEED.getValue() == decodedVersionByte) {
