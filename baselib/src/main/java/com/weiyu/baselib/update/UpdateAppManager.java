...
public class UpdateAppManager {
    ...
    private UpdateAppManager(UpdateAppManager.Builder builder) {
...
//    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setParams(Map<String, String> params) {
            this.params = params;
            return this;
        }
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setIgnoreDefParams(boolean ignoreDefParams) {
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setPost(boolean post) {
            isPost = post;
            return this;
        }
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setTargetPath(String targetPath) {
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setAppKey(String appKey) {
            mAppKey = appKey;
            return this;
        }
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setActivity(Activity activity) {
            mActivity = activity;
            return this;
        }
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setHttpManager(HttpManager httpManager) {
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setUpdateUrl(String updateUrl) {
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setThemeColor(int themeColor) {
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setTopPic(int topPic) {
            mTopPic = topPic;
            return this;
        }
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder setUpdateDialogFragmentListener(IUpdateDialogFragmentListener updateDialogFragmentListener) {
         ...
         * @return Builder
         */
        public UpdateAppManager.Builder hideDialogOnDownloading() {
            mHideDialog = true;
            return this;
        }
         ...
         * @return 是否忽略版本
         */
        public UpdateAppManager.Builder showIgnoreVersion() {
         ...
         * @return 是否显示进度条
         */
        public UpdateAppManager.Builder dismissNotificationProgress() {
        ...
        public UpdateAppManager.Builder setOnlyWifi() {
            mOnlyWifi = true;
            return this;
        }
        ...
        public UpdateAppManager.Builder handleException(ExceptionHandler exceptionHandler) {
