...
public class ClassicsFooter extends RelativeLayout implements RefreshFooter {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        REFRESH_FOOTER_PULLUP=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint9);
        REFRESH_FOOTER_RELEASE=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint10);
        REFRESH_FOOTER_LOADING=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint2);
        REFRESH_FOOTER_REFRESHING=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint3);
        REFRESH_FOOTER_FINISH=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint11);
        REFRESH_FOOTER_FAILED=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint12);
        REFRESH_FOOTER_ALLLOADED=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint13);
