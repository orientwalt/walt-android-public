...
//    public static String REFRESH_HEADER_LASTTIME = "'Last update' M-d HH:mm";
    ...
    private void initView(Context context, AttributeSet attrs) {
        REFRESH_HEADER_PULLDOWN=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint1);
        REFRESH_HEADER_REFRESHING=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint2);
        REFRESH_HEADER_LOADING=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint3);
        REFRESH_HEADER_RELEASE=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint4);
        REFRESH_HEADER_FINISH=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint5);
        REFRESH_HEADER_FAILED=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint6);
        REFRESH_HEADER_LASTTIME=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint7);
        REFRESH_HEADER_SECOND_FLOOR=context.getResources().getString(com.weiyu.baselib.R.string.smartrefresh_hint8);
